    ...
    <form onSubmit={handleSubmit}>
     <div className="mb-3">
      ...
      <div className="login-register input-group">
       <span className="login-register input-group-text">
        <i className="fas fa-user"></i>
       </span>
       <input
        type="text"
        name="username"
        className="login-register form-control"
        value={form.username}
     ...
     <div className="mb-3">
      <label htmlFor="phonenumber" className="login-register form-label">
       Phone Number
      </label>
      <div className="login-register input-group">
       <span className="login-register input-group-text">
     ...
     <button type="submit" className="login-register btn-primary">
      Register
     </button>
    </form>
    <p>
     Already have an account?{" "}
     <Link to="/login" className="login-register link-primary">
      Login here
     </Link>
    </p>
   </div>
