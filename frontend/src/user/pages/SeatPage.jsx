      ...
      const fetchFilm = async () => {
        try {
          const response = await axios.get(
            `http://localhost:5750/api/films/${id}`
          );
    ...
    <div className="user-seat">
      <Container className="min-vh-100 pb-5">
        ...
        <Row>
            ...
            >
              ...
              <div className="seat-selection-box">
                ...
                <div className="legend d-flex justify-content-center text-dark">
                  ...
                  <div className="mx-2">
                    <Image src={seat_unav} style={{ width: "20px" }} />{" "}
                    Unavailable
                  </div>
                  <div className="mx-2">
                    <Image src={seat_pick} style={{ width: "20px" }} /> Your
                    Choice
                  </div>
                </div>
              </div>
          ...
          <Col md="4">
            <div className="movie-details p-3 rounded mb-3">
              <Row>
                {film && (
                  <>
                    <Col>
                      <Image
                        ...
                        fluid
                      />
                      <h3 className="my-3 fw-bold text-center">
                        {film.name_film}
                      </h3>
                      <hr></hr>
              ...
              <div className="mt-2">
                <p className="d-flex justify-content-between">
                  ...
                  <span className="text-end">
                    {selectedSeats.join(", ") || "No Seats Chosen"}
                  </span>
                </p>
                <p className="d-flex justify-content-between">
              ...
              <Button
                className="btn btn-warning btn-lg fs-6 fw-semibold mt-3"
                style={{ width: "100%" }}
...
const Seat = ({ seat, handleSeatClick, selectedSeats }) => {
  return (
    <div
      ...
      style={{
        textAlign: "center",
        marginRight: seat.id.endsWith("5") ? "30px" : "10px",
      }}
    >
      <Image
        src={
