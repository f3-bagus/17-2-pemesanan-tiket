         ...
         <>
          <Col>
           <Image
            ...
            fluid
           />
           <h3 className="my-3 fw-bold text-center">{film.name_film}</h3>
           <hr></hr>
           <p className="d-flex justify-content-between">
            <strong>Cinema</strong>{" "}
            <span className="text-end">CGV - Pakuwon Mall Jogja</span>
           </p>
           <p className="d-flex justify-content-between">
            <strong>Date & Time</strong>{" "}
            <span className="text-end">Friday, 14 Jun 2024 - 19:25</span>
           </p>
           <p className="d-flex justify-content-between">
